...
#MAKE SURE THE LOCAL HOST IS THE IP OF THE CURRENT COMPUTER
print("Robot started")
...
listenSocket.bind((localhost, listenPort))# Uses port 3310
...
iUDPPortRobot = random.randint(0,9999) + 20000 # It creates a 12  string characters 
...
ports_to_send = str(iUDPPortRobot)+","+str(iUDPPortStudent) # it adds the previous strings together
